            ...
            <Grid item xs={3} >
              <Paper className={classes.formPaper}>
                ...
                <Grid container justify="center" >
                  <Grid item xs={6} >
                    <TextField className={classes.textFields} variant="outlined" error={!desc} label="Description" value={desc}
                      onChange={(e) => handleChangeDesc(e)}
                    />
                    <TextField className={classes.textFields} variant="outlined" error={!time} label="Time (Hours)" type="number" value={time}
